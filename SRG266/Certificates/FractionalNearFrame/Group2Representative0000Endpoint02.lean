...
/-! # Start-hybrid endpoint sum [9, 25) for group 2 representative 0 -/
...
theorem fractionalNearFrameGroup2Representative0000_endpoint02 :
    CompactIndexedStartHybridEndpointSumOn
      ...
      (((compactIndexedStartHybridEndpointIndices
        fractionalNearFrameGroup2Representative0000.nearMask).drop 5).drop 4)
      (-2088) := by
