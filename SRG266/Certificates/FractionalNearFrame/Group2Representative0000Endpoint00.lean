...
/-! # Start-hybrid endpoint sum [0, 5) for group 2 representative 0 -/
...
theorem fractionalNearFrameGroup2Representative0000_endpoint00 :
    CompactIndexedStartHybridEndpointSumOn
      ...
      ((compactIndexedStartHybridEndpointIndices
        fractionalNearFrameGroup2Representative0000.nearMask).take 5) 669 := by
